...
- **RelationshipEngine** / **SchemaIntelligence**: FK hints and column metadata for event display.
- **Data Breakpoints (19)**: events can drive breakpoint evaluation; "Add Breakpoint" from event.
- **Query Replay DVR (26)** / **Dashboard (36)** / **Unified Timeline (6.1)**: mutation events can feed DVR, dashboard widget, and timeline `mutation` events.
- **Actions from event**: "View Row" → table viewer; "View Impact" → Row Impact; "Trace Lineage" → Data Lineage.
