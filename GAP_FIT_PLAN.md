...
- Cell copy button (Low / Med)
- Copy migration SQL (Low / Med)
- SQL templates (Low / Med)
- Clickable ER diagram tables (Low / Med)
- Masked CSV export (Low / Med)

### For the Website

- EXPLAIN query plan (Low / High)
- Clear table/all commands (Low / Med)
- Clipboard paste import (Low / Med)
- Configurable slow threshold (Low / Med)
