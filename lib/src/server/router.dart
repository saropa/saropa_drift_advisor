...
final class Router {
  ...
  Future<void> onRequest(HttpRequest request) async {
    ...
    if (_ctx.authTokenHash != null ||
        (_ctx.basicAuthUser != null &&
            _ctx.basicAuthPassword != null)) {
    ...
    try {
      ...
      if (req.method == ServerConstants.methodGet &&
          (path.startsWith(ServerConstants.pathApiTablePrefix) ||
              path.startsWith(
                  ServerConstants.pathApiTablePrefixAlt))) {
        final String suffix =
        ...
        final int limit = ServerContext.parseLimit(
            req.uri.queryParameters[
                ServerConstants.queryParamLimit]);
        final int offset = ServerContext.parseOffset(
            req.uri.queryParameters[
                ServerConstants.queryParamOffset]);
      ...
      if (req.method == ServerConstants.methodGet &&
          (path == ServerConstants.pathApiSchemaDiagram ||
              path ==
                  ServerConstants.pathApiSchemaDiagramAlt)) {
      ...
      if (req.method == ServerConstants.methodGet &&
          (path == ServerConstants.pathApiSchemaMetadata ||
              path ==
                  ServerConstants.pathApiSchemaMetadataAlt)) {
      ...
      if (req.method == ServerConstants.methodGet &&
          (path == ServerConstants.pathApiSnapshotCompare ||
              path ==
                  ServerConstants.pathApiSnapshotCompareAlt)) {
      ...
      if (req.method == ServerConstants.methodGet &&
          (path.startsWith(
                  ServerConstants.pathApiComparePrefix) ||
              path.startsWith(
                  ServerConstants.pathApiComparePrefixAlt))) {
        await _compare.handleCompareReport(res, req, query);
        return;
      }
      if (req.method == ServerConstants.methodGet &&
          (path == ServerConstants.pathApiIndexSuggestions ||
              path ==
                  ServerConstants.pathApiIndexSuggestionsAlt)) {
      ...
      if (req.method == ServerConstants.methodGet &&
          (path == ServerConstants.pathApiMigrationPreview ||
              path ==
                  ServerConstants.pathApiMigrationPreviewAlt)) {
        await _compare.handleMigrationPreview(res, query);
        return;
      }
      if (req.method == ServerConstants.methodGet &&
          (path ==
                  ServerConstants.pathApiAnalyticsAnomalies ||
              path ==
                  ServerConstants
                      .pathApiAnalyticsAnomaliesAlt)) {
      ...
      if (req.method == ServerConstants.methodGet &&
          (path == ServerConstants.pathApiAnalyticsSize ||
              path ==
                  ServerConstants.pathApiAnalyticsSizeAlt)) {
      ...
      if (req.method == ServerConstants.methodPost &&
          (path == ServerConstants.pathApiSessionShare ||
              path ==
                  ServerConstants.pathApiSessionShareAlt)) {
        await _session.handleSessionShare(req);
        return;
      }
      if (path.startsWith(
              ServerConstants.pathApiSessionPrefix) ||
          path.startsWith(
              ServerConstants.pathApiSessionPrefixAlt)) {
        final suffix = path.startsWith(
                ServerConstants.pathApiSessionPrefix)
            ? path.substring(
                ServerConstants.pathApiSessionPrefix.length)
            : path.substring(
                ServerConstants.pathApiSessionPrefixAlt.length);

        if (suffix.endsWith(
                ServerConstants.pathSuffixAnnotate) &&
      ...
      if (req.method == ServerConstants.methodGet &&
          (path ==
                  ServerConstants
                      .pathApiAnalyticsPerformance ||
              path ==
                  ServerConstants
                      .pathApiAnalyticsPerformanceAlt)) {
