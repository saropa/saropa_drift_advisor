// Platform selection: VM (dart:io) gets the real HTTP server in drift_debug_server_io.dart;
// web (no dart:io) gets the stub so the same import works and [DriftDebugServer.start] throws
