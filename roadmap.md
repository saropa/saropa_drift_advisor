...
| -------- | -------------------------------------------------------- | :---: | :----: | ------------------------------------------- |
| **1**    | [28: PII Anonymizer](plans/deferred/PLAN_PII_ANONYMIZER.md)        |  5→6  | Medium | Extension-only, uses existing endpoints     |
...
| --- | ------------------------------------------------------------------- | :---: | :----: | ----------------------------------- |
| 28  | [PII Anonymizer](plans/deferred/PLAN_PII_ANONYMIZER.md)                        |  5→6  | Medium | Extension-only (existing endpoints) |
| 60  | [Time-Travel Slider](plans/history/2026.09/20260902/60-time-travel-data-slider.md)           |  5→6  | Medium | ↔ DVR, Timeline                     |
| 59  | [AI Schema Reviewer](plans/deferred/PLAN_AI_SCHEMA_REVIEWER.md)                |  5→6  | Medium | Requires LLM integration            |
...
| 35  | [Multi-Server Federation](plans/deferred/PLAN_MULTI_SERVER_FEDERATION.md) |  5→6  |  High  | Multiple clients        |
