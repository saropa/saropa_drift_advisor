...
1. Command palette → "Drift Viewer: Generate Schema Documentation"
...
<body>
  ...
  <footer>
    <p>Generated by <a href="https://pub.dev/packages/saropa_drift_viewer">Drift Viewer</a></p>
  </footer>
</body>
</html>`;
  }
    ...
    "commands": [
      {
        ...
        "title": "Drift Viewer: Generate Schema Documentation",
        "icon": "$(book)"
      }
    ],
    "menus": {
