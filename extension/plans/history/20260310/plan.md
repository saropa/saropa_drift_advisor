...
| 19 | [Data Breakpoints](19-data-breakpoints.md) | Pause the debugger when data conditions are met. |
| 20a | [Data Management](20a-data-management.md) | **IMPLEMENTED.** Reset, Import, Export, Table Groups — prerequisite for 20, 28, 37, 46, 47. |
| 20 | [Test Data Seeder](20-test-data-seeder.md) | Auto-generate realistic test data respecting FK relationships. Depends on 20a. |
...
| 20 | Test Data Seeder | 4 | Low | **Very High** | Medium |
| 33 | Row Comparator | 3 | Low | **Very High** | Medium |
| 39 | Cross-Table Global Search | 4 | Low | **Very High** | High |
| 42 | Data Annotations & Bookmarks | 3 | Low | **High** | Medium |
| 45 | Data Sampling Explorer | 3 | Low | **High** | Medium |
| 29 | Smart Column Profiler | 4 | Low | **High** | Medium |
| 34 | Snapshot Changelog Narrative | 4 | Low | **High** | High |
| 32 | Schema Documentation Generator | 4 | Low | **High** | Medium |
| 40 | SQL Snippet Library | 3 | Low | **High** | Low |
| 24 | Drift Migration Generator | 5 | Medium | **High** | High |
| 19 | Data Breakpoints | 5 | Medium | **High** | Very High |
...
2. **20 — Test Data Seeder** — Fast to build, every Drift user wants it
