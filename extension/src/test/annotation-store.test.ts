/**
 * Core CRUD tests for AnnotationStore.
 *
 * Covers: add, update, remove, filtering, persistence, and event
 * subscription. Bulk operations (clearAll, removeForTable,
 * removeAllForTable, removeForColumn) and export/import live in
 * annotation-store-bulk.test.ts.
 */
...
describe('AnnotationStore', () => {
  ...
  // Reusable target fixtures — one per annotation kind so every test
  // can mix-and-match without re-declaring.
