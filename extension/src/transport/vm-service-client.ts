...
import type { VmExtensionEvent, VmServiceClientConfig } from './vm-service-client-types';

export type { VmExtensionEvent, VmServiceClientConfig } from './vm-service-client-types';
