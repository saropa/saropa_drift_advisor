...
(function() {
  ...
  function renderFilterBar() {
    ...
    html += '<button id="drift-filter-save" style="' +
      'background:var(--vscode-charts-green,#2e7d32);color:#fff;border:none;border-radius:3px;' +
    ...
    html += '<button id="drift-filter-delete" style="' +
      'background:var(--vscode-charts-red,#d32f2f);color:#fff;border:none;border-radius:3px;' +
  ...
  window.addEventListener('message', function(event) {
    ...
    if (msg.command === 'filterError') {
      ...
      errOverlay.innerHTML =
        '<p style="color:var(--vscode-errorForeground,#d32f2f);font-size:14px;' +
