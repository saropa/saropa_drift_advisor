...
5. Manifest strings (command titles, setting descriptions) remain English-only for a separate reason — see `bugs/BUG_INFRA_PACKAGE_NLS_LOCALE_FILES_MISSING.md`.
