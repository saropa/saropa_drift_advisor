...
- `doc/API.md` updated to version 4.2.3: added 15 previously undocumented endpoint sections (views, declared schema, relationships, report, snapshots list/delete/rename, cell update, index preview/apply, soft relationships, query history, DVR, mutations); added HTTP 403 status code; expanded query parameter reference table.
...
For versions 4.1.0 and prior, see [CHANGELOG_ARCHIVE.md](./CHANGELOG_ARCHIVE.md).
